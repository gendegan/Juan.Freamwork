...
namespace Juan.Core
{
    public static class RSAHelper
    {
        ...
        /// <returns></returns>
        public static bool RSACheck(IDictionary<string, string> parameters, string signField, string publicKeyPem, string charset, string signType, bool keyFromFile, params string[] filterKeys)
        {
            string sign = parameters[signField];
        ...
        public static string RSASign(this string data, string privateKeyPem, string charset, string signType)
        {
            return RSASignCharSet(data, privateKeyPem, charset, signType);
        }
        public static string RSASign(this string data, string privateKeyPem, string charset, string signType, bool keyFromFile)
        {
            return RSASignCharSet(data, privateKeyPem, charset, keyFromFile, signType);
        }
        //*/
        public static string RSASignCharSet(this string data, string privateKeyPem, string charset, string signType)
        {
        ...
        public static bool RSACheckContent(this string signContent, string sign, string publicKeyPem, string charset, string signType, bool keyFromFile)
        {
        ...
        public static string RSADecrypt(this string content, string privateKeyPem, string charset, string signType)
        {
            try
            {
                RSACryptoServiceProvider rsaCsp = LoadCertificateFile(privateKeyPem, signType);
        ...
        public static string RSADecrypt(this string content, string privateKeyPem, string charset, string signType, bool keyFromFile)
        {
            try
            {
                RSACryptoServiceProvider rsaCsp = null;
